function qddot = fun_qddotssp_leftlimb(x,u,dt)
%%%% SSP phase- 2   %%%%%%%%%%%%%%
...
Ass1=[0,(-1),0,(-1);(-1),0,(-1),0;r4.*cos(tht4)+(-1).*r4t.*cos(gamma62+ ...
  ...
  tht4);(-1).*L2.*cos(tht2)+(m3+m4).^(-1).*(m4.*((-1).*R2.*cos(del2+ ...
  (-1).*tht1)+r4t.*cos(gamma62+tht4))+m3.*((-1).*R2.*cos(del2+(-1).* ...
  tht1)+(-1).*L3.*cos(tht3)+r3.*cos(tht3)+(-1).*r4.*cos(tht4)+r4t.* ...
  cos(gamma62+tht4))),0,(-1).*L2.*cos(tht2)+(m3+m4).^(-1).*(m4.*(( ...
  -1).*R2.*cos(del2+(-1).*tht1)+r4h.*cos(gamma61+tht4))+m3.*((-1).* ...
  R2.*cos(del2+(-1).*tht1)+(-1).*L3.*cos(tht3)+r3.*cos(tht3)+(-1).* ...
  r4.*cos(tht4)+r4h.*cos(gamma61+tht4))),0]
...
bss1=[(-1).*ax1.*m1+(-1).*m2.*(ax1+R2.*(omg1.^2.*cos(del2+(-1).*tht1)+( ...
  ...
  .*m1.*(m3+m4).^(-1).*(L3.*m4.*cos(tht3)+m3.*r3.*cos(tht3)+m4.*r4.* ...
  cos(tht4))+m2.*(x1+(-1).*R2.*cos(del2+(-1).*tht1)+(-1).*r2.*cos( ...
  tht2)+(-1).*(m3+m4).^(-1).*(m3.*(x1+(-1).*r3.*cos(tht3))+m4.*(x1+( ...
  -1).*L3.*cos(tht3)+(-1).*r4.*cos(tht4)))).*(ay1+g+(-1).*alp2.*r2.* ...
  cos(tht2)+(-1).*R2.*(alp1.*cos(del2+(-1).*tht1)+omg1.^2.*sin(del2+ ...
  (-1).*tht1))+omg2.^2.*r2.*sin(tht2))+(-1).*m2.*(y1+R2.*sin(del2+( ...
  -1).*tht1)+(-1).*r2.*sin(tht2)).*(ax1+R2.*(omg1.^2.*cos(del2+(-1) ...
  .*tht1)+(-1).*alp1.*sin(del2+(-1).*tht1))+r2.*(omg2.^2.*cos(tht2)+ ...
  alp2.*sin(tht2)))+m3.*((-1).*y1+(-1).*R2.*sin(del2+(-1).*tht1)+ ...
  L2.*sin(tht2)+r3.*sin(tht3)).*(ax1+L2.*omg2.^2.*cos(tht2)+ ...
  omg3.^2.*r3.*cos(tht3)+R2.*(omg1.^2.*cos(del2+(-1).*tht1)+(-1).* ...
  alp1.*sin(del2+(-1).*tht1))+alp2.*L2.*sin(tht2)+alp3.*r3.*sin( ...
  tht3))+m3.*(m3+m4).^(-1).*(m3.*R2.*cos(del2+(-1).*tht1)+m4.*R2.* ...
  cos(del2+(-1).*tht1)+L2.*(m3+m4).*cos(tht2)+(-1).*L3.*m4.*cos( ...
  tht3)+m4.*r3.*cos(tht3)+(-1).*m4.*r4.*cos(tht4)).*((-1).*ay1+(-1) ...
  .*g+alp2.*L2.*cos(tht2)+alp3.*r3.*cos(tht3)+R2.*(alp1.*cos(del2+( ...
  -1).*tht1)+omg1.^2.*sin(del2+(-1).*tht1))+(-1).*L2.*omg2.^2.*sin( ...
  tht2)+(-1).*omg3.^2.*r3.*sin(tht3))+m4.*((-1).*y1+(-1).*R2.*sin( ...
  ...
  tht4))+m4.*(m3+m4).^(-1).*(m3.*R2.*cos(del2+(-1).*tht1)+m4.*R2.* ...
  cos(del2+(-1).*tht1)+L2.*(m3+m4).*cos(tht2)+L3.*m3.*cos(tht3)+(-1) ...
  .*m3.*r3.*cos(tht3)+m3.*r4.*cos(tht4)).*((-1).*ay1+(-1).*g+alp2.* ...
  L2.*cos(tht2)+alp3.*L3.*cos(tht3)+alp4.*r4.*cos(tht4)+R2.*(alp1.* ...
  cos(del2+(-1).*tht1)+omg1.^2.*sin(del2+(-1).*tht1))+(-1).*L2.* ...
  omg2.^2.*sin(tht2)+(-1).*L3.*omg3.^2.*sin(tht3)+(-1).*omg4.^2.* ...
  r4.*sin(tht4))]
...
Mmat =[(-1).*m2.*R2.*sin(del2+(-1).*tht1)+(-1).*m3.*R2.*sin(del2+(-1).* ...
  ...
  (-1).*m4.*r4.*cos(tht4),0,m1+m2+m3+m4;MI1+m2.*R2.^2+m3.*R2.^2+m4.* ...
  R2.^2,L2.*m3.*R2.*cos(del2+(-1).*tht1+tht2)+L2.*m4.*R2.*cos(del2+( ...
  -1).*tht1+tht2)+m2.*r2.*R2.*cos(del2+(-1).*tht1+tht2),L3.*m4.*R2.* ...
  cos(del2+(-1).*tht1+tht3)+m3.*R2.*r3.*cos(del2+(-1).*tht1+tht3), ...
  m4.*R2.*r4.*cos(del2+(-1).*tht1+tht4),(-1).*m2.*R2.*sin(del2+(-1) ...
  .*tht1)+(-1).*m3.*R2.*sin(del2+(-1).*tht1)+(-1).*m4.*R2.*sin(del2+ ...
  (-1).*tht1),(-1).*m2.*R2.*cos(del2+(-1).*tht1)+(-1).*m3.*R2.*cos( ...
  del2+(-1).*tht1)+(-1).*m4.*R2.*cos(del2+(-1).*tht1);L2.*m3.*R2.* ...
  cos(del2+(-1).*tht1+tht2)+L2.*m4.*R2.*cos(del2+(-1).*tht1+tht2)+ ...
  m2.*r2.*R2.*cos(del2+(-1).*tht1+tht2),L2.^2.*(m3+m4)+MI2+m2.* ...
  r2.^2,L2.*L3.*m4.*cos(tht2+(-1).*tht3)+L2.*m3.*r3.*cos(tht2+(-1).* ...
  tht3),L2.*m4.*r4.*cos(tht2+(-1).*tht4),L2.*m3.*sin(tht2)+L2.*m4.* ...
  ...
  r3.^2,L3.*m4.*r4.*cos(tht3+(-1).*tht4),L3.*m4.*sin(tht3)+m3.*r3.* ...
  sin(tht3),(-1).*L3.*m4.*cos(tht3)+(-1).*m3.*r3.*cos(tht3);m4.*R2.* ...
  r4.*cos(del2+(-1).*tht1+tht4),L2.*m4.*r4.*cos(tht2+(-1).*tht4), ...
  L3.*m4.*r4.*cos(tht3+(-1).*tht4),MI4+m4.*r4.^2,m4.*r4.*sin(tht4),( ...
  -1).*m4.*r4.*cos(tht4)]
...
phi=[lam2+lam4+(-1).*m2.*omg1.^2.*R2.*cos(del2+(-1).*tht1)+(-1).*m3.* ...
  ...
  -1).*T2+g.*m2.*R2.*cos(del2+(-1).*tht1)+g.*m3.*R2.*cos(del2+(-1).* ...
  tht1)+g.*m4.*R2.*cos(del2+(-1).*tht1)+L2.*m3.*omg2.^2.*R2.*sin( ...
  del2+(-1).*tht1+tht2)+L2.*m4.*omg2.^2.*R2.*sin(del2+(-1).*tht1+ ...
  tht2)+m2.*omg2.^2.*r2.*R2.*sin(del2+(-1).*tht1+tht2)+L3.*m4.* ...
  omg3.^2.*R2.*sin(del2+(-1).*tht1+tht3)+m3.*omg3.^2.*R2.*r3.*sin( ...
  del2+(-1).*tht1+tht3)+m4.*omg4.^2.*R2.*r4.*sin(del2+(-1).*tht1+ ...
  tht4),T2+(-1).*T3+g.*L2.*m3.*cos(tht2)+g.*L2.*m4.*cos(tht2)+g.* ...
  m2.*r2.*cos(tht2)+(-1).*L2.*m3.*omg1.^2.*R2.*sin(del2+(-1).*tht1+ ...
  tht2)+(-1).*L2.*m4.*omg1.^2.*R2.*sin(del2+(-1).*tht1+tht2)+(-1).* ...
  m2.*omg1.^2.*r2.*R2.*sin(del2+(-1).*tht1+tht2)+(-1).*L2.*L3.*m4.* ...
  omg3.^2.*sin(tht2+(-1).*tht3)+(-1).*L2.*m3.*omg3.^2.*r3.*sin(tht2+ ...
  (-1).*tht3)+(-1).*L2.*m4.*omg4.^2.*r4.*sin(tht2+(-1).*tht4),T3+( ...
  -1).*T4+(-1).*L3.*(lam1+lam3).*cos(tht3)+g.*L3.*m4.*cos(tht3)+g.* ...
  m3.*r3.*cos(tht3)+L2.*L3.*m4.*omg2.^2.*sin(tht2+(-1).*tht3)+L2.* ...
  m3.*omg2.^2.*r3.*sin(tht2+(-1).*tht3)+L3.*(lam2+lam4).*sin(tht3)+( ...
  -1).*L3.*m4.*omg1.^2.*R2.*sin(del2+(-1).*tht1+tht3)+(-1).*m3.* ...
  ...
  gamma62+tht4)+L2.*m4.*omg2.^2.*r4.*sin(tht2+(-1).*tht4)+L3.*m4.* ...
  omg3.^2.*r4.*sin(tht3+(-1).*tht4)+(lam2+lam4).*r4.*sin(tht4)+(-1) ...
  .*lam4.*r4h.*sin(gamma61+tht4)+(-1).*lam2.*r4t.*sin(gamma62+tht4)+ ...
  (-1).*m4.*omg1.^2.*R2.*r4.*sin(del2+(-1).*tht1+tht4)]
...
Cmat=[(-1).*R2.*cos(del2+(-1).*tht1),(-1).*L2.*cos(tht2),(-1).*L3.*cos( ...
  tht3),(-1).*r4.*cos(tht4)+r4t.*cos(gamma62+tht4),0,1;(-1).*R2.* ...
  sin(del2+(-1).*tht1),L2.*sin(tht2),L3.*sin(tht3),r4.*sin(tht4)+( ...
  -1).*r4t.*sin(gamma62+tht4),1,0;(-1).*R2.*cos(del2+(-1).*tht1),( ...
  -1).*L2.*cos(tht2),(-1).*L3.*cos(tht3),(-1).*r4.*cos(tht4)+r4h.* ...
  cos(gamma61+tht4),0,1;(-1).*R2.*sin(del2+(-1).*tht1),L2.*sin(tht2) ...
...
rhs1=[lam2+lam4+(-1).*m2.*omg1.^2.*R2.*cos(del2+(-1).*tht1)+(-1).*m3.* ...
  omg1.^2.*R2.*cos(del2+(-1).*tht1)+(-1).*m4.*omg1.^2.*R2.*cos(del2+ ...
  (-1).*tht1)+(-1).*L2.*m3.*omg2.^2.*cos(tht2)+(-1).*L2.*m4.* ...
  omg2.^2.*cos(tht2)+(-1).*m2.*omg2.^2.*r2.*cos(tht2)+(-1).*L3.*m4.* ...
  omg3.^2.*cos(tht3)+(-1).*m3.*omg3.^2.*r3.*cos(tht3)+(-1).*m4.* ...
